...
You have probably downloaded the Windows 11 IoT Enterprise 2024 x64 version I talked about before. Here, we will be preparing an USB Flash Drive with that ISO using Rufus.
